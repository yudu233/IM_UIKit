...
public class PhotoPickerHelper {
    ...
    public static final String RESULT_CAMERA_DATA = "result_camera_data";
     ...
     * @param picPath
     */
    public static void startClipPic(Context context, PhotoPickBean photoPickBean, String picPath) {
    ...
    public static void sendImages(Activity context,PhotoPickBean pickBean, ArrayList<MediaData> data) {
        ...
        if (pickBean.getCallback() != null) {
            ...
            intent.putParcelableArrayListExtra(RESULT_CAMERA_DATA, data);
