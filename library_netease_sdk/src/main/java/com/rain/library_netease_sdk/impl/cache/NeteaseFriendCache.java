 ...
 * @Version : 1.0
 * @Descroption : 好友关系缓存:获取通讯录列表即是根据Friend列表帐号，去取对应的UserInfo
 */
public class NeteaseFriendCache implements BaseCache {

    public static NeteaseFriendCache getInstance() {
    ...
    public void buildCache() {
        ...
        // 排除掉自己
        accounts.remove(NimUIKitImpl.getAccount());
    ...
    static class InstanceHolder {
        final static NeteaseFriendCache instance = new NeteaseFriendCache();
    }
}
