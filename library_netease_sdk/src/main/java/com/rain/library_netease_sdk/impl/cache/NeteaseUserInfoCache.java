 ...
 * @Author : Rain
 * @Version : 1.0
 * @CreateDate :  2020/9/23 17:36
 * @Description :用户资料数据缓存，适用于用户体系使用网易云信用户资料托管
...
public class NeteaseUserInfoCache extends UserInfoCache<NimUserInfo> {
    ...
    private void addOrUpdateUsers(final List<NimUserInfo> users, boolean notify) {
        ...
        // FIXME: 2020/9/23 DataCacheManager
    ...
    static class InstanceHolder {
        final static NeteaseUserInfoCache instance = new NeteaseUserInfoCache();
    }
}
